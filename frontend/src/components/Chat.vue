...
<script setup>
import MomoIcon from './icons/IconMomo.vue'
import SettingIcon from './icons/IconSetting.vue'
import StudentIcon from './icons/IconStudent.vue'
...
<template>
    <div id="root">
        ...
        <main class="talk-wrapper" id="chatcard">
            <!-- 聊天主界面 -->
...
@import '@/assets/css/info-view.scss';
